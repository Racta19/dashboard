...
export const action = async ({request}: ActionFunctionArgs) => {
    ...
    try {
        ...
        // Remove stray ellipses or invalid trailing commas
        ...
        const imageResponse = await fetch(`https://api.unsplash.com/search/photos?query=${country} ${interests} ${travelStyle}&client_id=${unsplash}`);
