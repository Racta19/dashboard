  ...
  return (
    <header className='header'>
      <article>
        ...
        <h1 className={cn("text-dark-100", loaction.pathname === "/" ? 'text-2xl md:text-4xl font-bold' : 'text-xl md:text-2xl font-semibold')}>
          {title}
        </h1>
        
        <p className={cn("text-gray-100 font-normal", loaction.pathname === "/" ? 'text-base md:text-lg' : 'text-sm md:text-lg')}>
          {description}
        </p>
      </article>
      {ctaText && ctaUrl && (
