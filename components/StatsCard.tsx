  ...
  return (
    <article className='stats-card'>
        ...
        <div className='content'>
          ...
          {/* Make these charts functional using charts js or syncfusion chart components or any other library */}
          {/**Make a feature that can show more predictions and financial tools */}
          <img src={`/assets/icons/${isDecrement ? 'decrement.svg': 'increment.svg'}`} className='xl:w-32 xl:h-full w-full h-full md:h-32'  alt="Trend Graphs" />
